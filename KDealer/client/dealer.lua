        ...
        RageUI.Visible(WeaponDealer, not RageUI.Visible(WeaponDealer))
            ...
            RageUI.IsVisible(WeaponDealer, true, true, true, function()
                ...
                RageUI.ButtonWithStyle("→ Terminer l'achat",nil, {RightLabel = ""}, true, function(Hovered, Active, Selected)
                    ...
                    ESX.ShowNotification('[~r~Ezequiel~w~] *Message Radio* la personne descend')
                    RageUI.CloseAll()
                    end
                end)
                ...
                RageUI.ButtonWithStyle("→ Pistolet","Prix : 125 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                    if a then
                ...
                RageUI.ButtonWithStyle("→ Pistolet Calibre 50","Prix : 200 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                    if a then
                ...
                RageUI.ButtonWithStyle("→ Pistolet Pétoire", "Prix : 80 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                    if a then
                ...
                RageUI.ButtonWithStyle("→ Pistolet de Combat", "Prix : 150 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                    if a then
                ...
                RageUI.ButtonWithStyle("→ Pistolet Vintage","Prix : 300 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                    if a then
                ...
                RageUI.ButtonWithStyle("→ M4A1","Prix : 175 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                    if a then
                ...
                RageUI.ButtonWithStyle("→ MP5","Prix : 125 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                    if a then
                ...
                RageUI.ButtonWithStyle("→ Matraque", "Prix : 5000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                    if a then
                ...
                RageUI.ButtonWithStyle("→ Tazer", "Prix : 1000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                    if a then
               ...
               RageUI.Separator("↓ ~o~   Voici les armes blanches  ~s~↓")
                ...
                RageUI.ButtonWithStyle("→ Couteau", "Prix : 15 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                    if a then
                ...
                RageUI.ButtonWithStyle("→ Batte", "Prix : 15 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                    if a then
                ...
                RageUI.ButtonWithStyle("→ Dague", "Prix : 15 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                    if a then
                ...
                RageUI.ButtonWithStyle("→ Bouteille", "Prix : 15 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                    if a then
                ...
                RageUI.ButtonWithStyle("→ Pied de biche", "Prix : 15 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                    if a then
                ...
                TriggerServerEvent('Kaitoachetedesarmes', item, labeletn, prix)
                    ...
                    RageUI.ButtonWithStyle("→ Club de Golf", "Prix : 15 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                        if a then
                        ...
                        RageUI.ButtonWithStyle("→ Marteau", "Prix : 15 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                            if a then
                            ...
                            RageUI.ButtonWithStyle("→ Hachette", "Prix : 15 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                                if a then
                                ...
                                RageUI.ButtonWithStyle("→ Poing Américain", "Prix : 15 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                                    if a then
                                ...
                                RageUI.ButtonWithStyle("→ Machette", "Prix : 15 000$", {RightLabel = ""},true, function(Hovered, a, Selected)
                                    if a then
        ...
        for k in pairs(position) do 
            ...
            if dist <= 1.0 then
			   ...
			   RageUI.Text({
				...
				message = "Appuyez sur [~r~E~w~] pour parler avec Ezequiel",
